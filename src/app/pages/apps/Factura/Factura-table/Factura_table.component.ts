...
@Component({
  ...
  templateUrl: './Factura_table.component.html',
  styleUrls: ['./Factura_table.component.scss'],
  animations: [
    stagger40ms,
    scaleIn400ms,
    fadeInRight400ms
...
export class FacturaTableComponent implements OnInit {
 ...
 isActive(category: ContactsTableMenu['id']) {
  ...
  openContact(c_Id_Categoria?: FacturaData['c_Id_Categoria']) {
