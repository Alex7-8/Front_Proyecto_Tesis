...
@Component({
  ...
  templateUrl: './Factura_data_table.component.html',
  styleUrls: ['./Factura_data_table.component.scss'],
  providers: [
    {
...
export class FacturaDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: FacturaData['c_Id_Categoria']) {
