...
import { FacturaEditComponent } from '../components/Factura-edit/Factura-edit.component';
...
@Component({
  ...
  templateUrl: './Factura-grid.component.html',
  styleUrls: ['./Factura-grid.component.scss'],
  animations: [
    scaleIn400ms,
    fadeInRight400ms,
    stagger40ms,
...
export class FacturaGridComponent implements OnInit {
  ...
  filteredContacts$: Observable<FacturaData[]> = of([]);
  loadingData = true;
  ...
  openContact(id?: FacturaData['c_Id_Categoria']) {
    this.dialog.open(FacturaEditComponent, {
      data: id || null,
      width: '45rem'
    });
  }
  ...
  toggleStar(c_Id_Categoria: FacturaData['c_Id_Categoria']) {
