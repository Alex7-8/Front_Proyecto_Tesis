...
@Component({
  ...
  templateUrl: './FacturaCompra-grid.component.html',
  styleUrls: ['./FacturaCompra-grid.component.scss'],
  animations: [
    scaleIn400ms,
    fadeInRight400ms,
    stagger40ms,
...
export class FacturaCompraGridComponent implements OnInit {
  ...
  filteredContacts$: Observable<FacturaCompraData[]> = of([]);
  loadingData = true;
  ...
  openContact(id?: FacturaCompraData['c_Id_Factura']) {
