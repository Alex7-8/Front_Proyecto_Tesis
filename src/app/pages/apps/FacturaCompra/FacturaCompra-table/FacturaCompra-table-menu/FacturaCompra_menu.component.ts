...
@Component({
  ...
  templateUrl: './FacturaCompra_menu.component.html',
  animations: [fadeInRight400ms, stagger40ms]
})
export class FacturaCompraTableMenuComponent implements OnInit {
  Producto: FacturaCompraData[] = [];
  ...
  @Output() filterChange = new EventEmitter<FacturaCompraData[]>();
  ...
  constructor(private CrearUsuariosService:CrearUsuariosService,
              private em:FacturaCompraTableComponent,
  ...
  onToggleChange(event: any): void {
    ...
    if (event.checked  &&  this.em.activeCategory == 'Activo') {
      ...
      this.router.navigate(['/apps/FacturaCompra/grid/inactivos']);
