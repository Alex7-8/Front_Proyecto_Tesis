...
@Component({
  ...
  templateUrl: './FacturaCompra_data_table.component.html',
  styleUrls: ['./FacturaCompra_data_table.component.scss'],
  providers: [
    {
...
export class FacturaCompraDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: FacturaCompraData['c_Id_Factura']) {
