...
@Component({
  ...
  templateUrl: './FacturaVenta_menu.component.html',
  animations: [fadeInRight400ms, stagger40ms]
})
export class FacturaVentaTableMenuComponent implements OnInit {
  Producto: FacturaVentaData[] = [];
  ...
  @Output() filterChange = new EventEmitter<FacturaVentaData[]>();
  ...
  constructor(private CrearUsuariosService:CrearUsuariosService,
              private em:FacturaVentaTableComponent,
