...
@Component({
  ...
  templateUrl: './FacturaVenta-grid.component.html',
  styleUrls: ['./FacturaVenta-grid.component.scss'],
  animations: [
    scaleIn400ms,
    fadeInRight400ms,
    stagger40ms,
...
export class FacturaVentaGridComponent implements OnInit {
  ...
  filteredContacts$: Observable<FacturaVentaData[]> = of([]);
  loadingData = true;
