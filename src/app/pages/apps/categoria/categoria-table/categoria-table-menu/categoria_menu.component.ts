...
@Component({
  ...
  templateUrl: './categoria_menu.component.html',
  animations: [fadeInRight400ms, stagger40ms]
})
export class CategoriaTableMenuComponent implements OnInit {
  ...
  @Output() filterChange = new EventEmitter<CategoriaData[]>();
  ...
  constructor(private CrearUsuariosService:CrearUsuariosService,
              private em:CategoriaTableComponent,
