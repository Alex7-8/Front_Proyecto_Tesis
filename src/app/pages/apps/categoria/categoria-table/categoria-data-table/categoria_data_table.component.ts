...
@Component({
  ...
  templateUrl: './categoria_data_table.component.html',
  styleUrls: ['./categoria_data_table.component.scss'],
  providers: [
    {
...
export class CategoriaDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: CategoriaData['c_Id_Categoria']) {
