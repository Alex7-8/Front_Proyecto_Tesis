...
@Component({
  ...
  templateUrl: './servicio_data_table.component.html',
  styleUrls: ['./servicio_data_table.component.scss'],
  providers: [
    {
...
export class ServicioDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: ServicioData['c_Id_Servicio']) {
