...
@Component({
  ...
  templateUrl: './Cliente_data_table.component.html',
  styleUrls: ['./Cliente_data_table.component.scss'],
  providers: [
    {
...
export class ClienteDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: ClienteData['c_Id_Persona']) {
