...
@Component({
  ...
  templateUrl: './Cliente_table.component.html',
  styleUrls: ['./Cliente_table.component.scss'],
  animations: [
    stagger40ms,
    scaleIn400ms,
    fadeInRight400ms
...
export class ClienteTableComponent implements OnInit {
  ...
  tableColumns: EmpleadoTableColumn<ClienteData>[] = [
 ...
 isActive(category: ContactsTableMenu['id']) {
  ...
  obtenerTablaData() {
    this.CrearUsuariosService.getCliente("").subscribe((response: any) => {
  ...
  openContact(c_Id_Persona?: ClienteData['c_Id_Persona']) {
  ...
  private checkScreenSize() {
    if (window.innerWidth < 768) {
      this.router.navigate(['/apps/Cliente/grid/activos']); // Cambiar a la vista en tarjetas
    }
  }
