...
@Component({
  ...
  templateUrl: './FacturaServicios_table.component.html',
  styleUrls: ['./FacturaServicios_table.component.scss'],
  animations: [
    stagger40ms,
    scaleIn400ms,
    fadeInRight400ms
...
export class FacturaServiciosTableComponent implements OnInit {
 ...
 searchCtrl = new UntypedFormControl();
  ...
  tableColumns: EmpleadoTableColumn<FacturaServiciosData>[] = [
 ...
 isActive(category: ContactsTableMenu['id']) {
  ...
  openContact(c_Id_Factura?: FacturaServiciosData['c_Id_Factura']) {
  ...
  setData(data: FacturaServiciosData[]) {
    this.tableData = data;
    this.menuOpen = false;
  }
