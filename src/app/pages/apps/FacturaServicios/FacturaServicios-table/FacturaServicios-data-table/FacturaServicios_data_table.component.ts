...
@Component({
  ...
  templateUrl: './FacturaServicios_data_table.component.html',
  styleUrls: ['./FacturaServicios_data_table.component.scss'],
  providers: [
    {
...
export class FacturaServiciosDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: FacturaServiciosData['c_Id_Factura']) {
