...
@Component({
  ...
  templateUrl: './Proveedor-grid.component.html',
  styleUrls: ['./Proveedor-grid.component.scss'],
  animations: [
    scaleIn400ms,
    fadeInRight400ms,
    stagger40ms,
...
export class ProveedorGridComponent implements OnInit {
  ...
  filteredContacts$: Observable<ProveedorData[]> = of([]);
  loadingData = true;
  ...
  OpenContact(id?: ProveedorData['c_Id_Persona']) {
