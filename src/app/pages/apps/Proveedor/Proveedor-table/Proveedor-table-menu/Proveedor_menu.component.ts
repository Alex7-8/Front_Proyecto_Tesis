...
@Component({
  ...
  templateUrl: './Proveedor_menu.component.html',
  animations: [fadeInRight400ms, stagger40ms]
})
export class ProveedorTableMenuComponent implements OnInit {
  empleado: ProveedorData[] = [];
  ...
  constructor(private CrearUsuariosService:CrearUsuariosService,
              private PTC:ProveedorTableComponent,
