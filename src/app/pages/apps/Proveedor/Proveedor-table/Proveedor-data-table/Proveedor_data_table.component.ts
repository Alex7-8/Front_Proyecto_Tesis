...
@Component({
  ...
  templateUrl: './Proveedor_data_table.component.html',
  styleUrls: ['./Proveedor_data_table.component.scss'],
  providers: [
    {
...
export class ProveedorDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: ProveedorData['c_Id_Persona']) {
