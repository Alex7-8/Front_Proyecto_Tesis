...
@Component({
  ...
  templateUrl: './venta_data_table.component.html',
  styleUrls: ['./venta_data_table.component.scss'],
  providers: [
    {
...
export class VentaDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: VentaData['c_Id_Producto']) {
