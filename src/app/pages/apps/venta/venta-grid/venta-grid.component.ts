...
@Component({
  ...
  templateUrl: './venta-grid.component.html',
  styleUrls: ['./venta-grid.component.scss'],
  animations: [
    scaleIn400ms,
    fadeInRight400ms,
    stagger40ms,
...
export class VentaGridComponent implements OnInit {
  ...
  filteredContacts$: Observable<VentaData[]> = of([]);
  loadingData = true;
  ...
  openContact(id?: VentaData['c_Id_Producto']) {
